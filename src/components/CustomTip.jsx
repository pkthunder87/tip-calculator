    ...
    <div>
      {customTip ? (
        <input
          ...
          className="h-12 w-[9.2rem] cursor-pointer rounded-[6px] bg-very-light-grayish-cyan px-2  text-end text-2xl font-bold text-very-dark-cyan caret-highlight-cyan outline-none ring-highlight-cyan placeholder:text-input-cyan
        focus:ring-2 sm:h-[2.2rem] sm:w-[5.6rem] sm:rounded-[4px] xl2:h-[3.75rem] xl2:w-[9.15rem] xl2:rounded-[5px] xl2:p-4 xl2:text-3xl"
          name="custom"
          type="text"
          {...register('customTip', {

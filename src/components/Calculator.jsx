  ...
  return (
    <div className="-mt-10 flex h-full w-full items-center justify-center">
      <form
        ...
        className="grid h-[102%] w-full items-center justify-center rounded-t-[22px] bg-white py-8 shadow-[0_15px_30px_20px_rgb(0,73,77,.09)]  sm:flex sm:h-[101%] sm:w-[64%] sm:gap-[4%] sm:rounded-[16px] sm:p-[2%] xl:w-[60%] xl2:w-[63.8%] xl2:rounded-[24px] xl2:p-[2.1%]"
      >
        <div className="-mb-3 ml-0 flex h-full w-[82dvw] flex-col gap-8 rounded-[26px] pl-0  pr-0 font-bold text-dark-grayish-cyan sm:mb-0 sm:ml-0  sm:h-[100%] sm:w-[48%] sm:p-4 xl2:gap-12 xl2:py-[1.6rem] xl2:pl-[1.33rem] xl2:pr-5">
          ...
          <fieldset className="grid grid-cols-2 gap-4 text-lg font-bold text-white sm:grid-cols-3 sm:gap-3 xl:mt-1 xl:gap-4 xl2:mt-0 xl2:gap-5 ">
            <legend className=" mb-4 mt-0 text-base text-dark-grayish-cyan sm:mb-[1.3rem] xl:mb-3 xl:text-[1.25rem] xl2:mb-[1.75rem] xl2:mt-[.52rem]">
              Select Tip %
            </legend>

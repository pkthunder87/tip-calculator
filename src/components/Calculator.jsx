...
function Calculator() {
  ...
  return (
    <div className="-mt-10 flex h-full w-full items-center justify-center">
      ...
      >
        <div className="ml-2 flex h-full w-[82dvw] flex-col gap-8 rounded-[26px] pl-0 pr-0  font-bold text-dark-grayish-cyan sm:ml-0 sm:h-[100%]  sm:w-[48%] sm:gap-12 sm:p-4 xl2:py-[1.6rem] xl2:pl-[1.33rem] xl2:pr-5">

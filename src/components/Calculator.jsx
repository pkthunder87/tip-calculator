...
function Calculator() {
  ...
  return (
    <div className="-mt-10 flex h-full w-full items-center justify-center">
      ...
      >
        <div className="-mb-3 ml-0 flex h-full w-[82dvw] flex-col gap-8 rounded-[26px] pl-0  pr-0 font-bold text-dark-grayish-cyan sm:mb-0 sm:ml-0  sm:h-[100%] sm:w-[48%] sm:gap-12 sm:p-4 xl2:py-[1.6rem] xl2:pl-[1.33rem] xl2:pr-5">
          ...
          <fieldset className="grid grid-cols-2 gap-4 text-lg font-bold text-white sm:grid-cols-3 sm:gap-3 xl2:gap-5 ">
            <legend className=" mb-4 mt-0 text-base text-dark-grayish-cyan sm:mb-[1.3rem] sm:text-xs xl2:mb-[1.75rem] xl2:mt-[.52rem] xl2:text-[1.25rem]">
              Select Tip %
            </legend>
